---
name: hide
description: Post-hoc cleanup of rule, secret, and cognitive leakage from files. Strips leakage patterns from generated code and docs. Supports file-level purge (HITL) for thought-process artifacts. File-scoped only — does not affect agent replies.
metadata:
  author: HuaTalk
  version: "0.1.0"
